...
* **Vitest** (tests unitarios, 769 en total)
...
**769 tests con Vitest** se ejecutan en CI en cada push, seguidos de las builds de producción de ambas apps:
