...
* **Vitest** (tests unitarios, 758 en total)
...
**758 tests con Vitest** se ejecutan en CI en cada push, seguidos de las builds de producción de ambas apps:
